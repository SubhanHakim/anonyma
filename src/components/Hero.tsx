                ...
                >
                    ...
                    <div className="pt-12 flex flex-col items-center gap-12">
                        ...
                        <div className="flex gap-6">
                            {/* X Button */}
                            <a href="https://x.com/ANONYMA_ASCII" className="group flex items-center justify-center w-14 h-14 bg-white border-2 border-[#1a1a1a] hover:bg-[#1a1a1a] transition-all duration-300 shadow-[0_0_15px_rgba(0,0,0,0.05)] hover:shadow-none">
                            ...
                            {/* Pumpfun Button */}
                            <a href="https://pump.fun/coin/CKtArYCuwzmxe9kXkFBWCeMsZKNbb7SLuW1B8Mw3pump" className="group relative px-8 h-14 flex items-center gap-3 bg-white border-2 border-[#1a1a1a] hover:bg-[#1a1a1a] transition-all duration-300 shadow-[0_0_15px_rgba(0,0,0,0.05)] hover:shadow-none overflow-hidden">
