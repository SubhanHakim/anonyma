    ...
    return (
        ...
        >
            ...
            <div className="relative z-10 flex flex-col items-center">
                ...
                >
                    {/* X Button */}
                    <a href="https://x.com/ANONYMA_ASCII" className="group flex items-center justify-center w-14 h-14 bg-white border-2 border-[#1a1a1a] hover:bg-[#1a1a1a] transition-all duration-300 shadow-none hover:shadow-lg">
                    ...
                    {/* Pumpfun Button */}
                    <a href="https://pump.fun/coin/9KWWmLgSbo1vQ9QfamPvY8sMM7LSQknJN8UhFcp2pump" className="group relative px-8 h-14 flex items-center gap-3 bg-white border-2 border-[#1a1a1a] hover:bg-[#1a1a1a] transition-all duration-300 shadow-none hover:shadow-lg overflow-hidden">
